...
$translationStrings = array(
    ...
    "NewTerminalPlayer"=>"New Terminal",
    ...
    "SearchTerminalPlayers"=>"Search Terminals",
    ...
    "SearchCashiersCollectors"=>"Search Cashiers - Collectors",
    ...
    "PlayersCreditTransfer"=>"Cashier Players",
    ...
    "Affiliate_PotIncome"=>"Pot income",
    ...
    "Panic"=>"Panic mode active",
    "Unset Panic"=>"Turn off panic mode",
    "Panic List"=>"Affiliates with active panic mode",
    ...
    "Active Games"=>"Game",
    "Cashiers"=>"Cashiers",
    "Touchscreen Credit Transfer"=>"Cashier Terminals",
    "Pin Code"=>"Pin Code",
    ...
    "Status Locked"=>"Banned from upper level!",
    ...
    "This terminal will be rejected and transfered into list of New and Rejected. Are you sure?"=>"This terminal will be rejected and transfered into list of New and Rejected. Are you sure?",
    ...
    "Ban all under this affiliate?"=>"Ban this affiliate and all subaffiliates?",
    ...
    "Unban all under this affiliate?"=>"Unban this affiliate and all subaffiliates?",
    ...
    "Game server information successfully updated !!!"=>"Game server information successfully updated !!!",
    ...
    "AllAffiliatesBanned_Question"=>"The affiliate <b> %1\$s </b> and all subaffiliates will be banned. Are you sure?",
    "AllAffiliatesUnbanned_Question"=>"The affiliate <b> %1\$s </b> and all subaffiliates will be unbanned. Are you sure?",
    ...
    "Cash Report List"=>"Cash Report List",
    ...
    "View Cash Report Daily List"=>"List View",
    ...
    "Collect Cash Tree"=>"Collect",
    "View Collect Cash"=>"Back to standard report",
    "View Collect Cash Tree"=>"Treeview",
    ...
    "Registred Subject"=>"Register site / domain",
    ...
    "Affiliate Game Setup Panel"=>"Affiliate game setup",
    ...
    "Cashier Players ALL"=>"Cashier Players ALL",
    "Value is required and can\'t be empty"=>"Value is required and can\'t be empty !",
    ...
    "Cashier Payout Players ALL"=>"Cashier Payout Players ALL",
    ...
    "Complete Statistic"=>"Total Statistic",
    ...
    "Cashier (TOUCH) Player / Terminals"=>"Cashier Player / Terminals",
    ...
    "Integration Cash Report List"=>"Integration Cash Report List",
    ...
    "Ticket Terminal Shop Setup"=>"Shop Setup",
    ...
    "Symbols" => "Symbols",
    "Hit freq." => "Hit frequency", /* ucestalost dobitka */
    ...
    "Select Game"=>"Select Game",
    "Select Player"=>"Select Player",
    "Set Affiliate Datum Code" => "Set Affiliate Date Code",
    "Datum Code" => "Date Code",
    "Set Datum Code" => "Set Date Code",
    "Name From" => "From",
    "Name To" => "To",
