...
class ListCreditReportMinForm extends Zend_Form {
	public function __construct($options = null) {
		...
		$this->setAction($baseUrl . '/'. $lang . '/cashier-reports/credit-report-min');
		...
		$this->setDecorators(array(array('ViewScript', array('viewScript'=>'viewScripts/cashier_reports/ListCreditReportMinViewScript.phtml'))));
