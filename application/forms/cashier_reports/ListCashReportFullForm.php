...
class ListCashReportFullForm extends Zend_Form {
	public function __construct($options = null) {
		parent::__construct($options);
		$baseUrl = Zend_Controller_Front::getInstance()->getBaseUrl();
		$this->setName('list-cash-report');
		$this->setMethod('post');
		$lang = Zend_Registry::get("lang");
		$this->setAction($baseUrl . '/'. $lang . '/cashier-reports/cash-report');
		...
		$this->setDecorators(array(array('ViewScript', array('viewScript'=>'viewScripts/cashier_reports/ListCashReportFullViewScript.phtml'))));
