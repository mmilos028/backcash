...
class ListCreditTransfersReportMinForm extends Zend_Form {
	public function __construct($options = null) {
		...
		$this->setDecorators(array(array('ViewScript', array('viewScript'=>'viewScripts/cashier_reports/ListCreditTransfersReportFormMinViewScript.phtml'))));
		$this->addElements(array($pageNo, $limitItems, $startdate, $enddate, $filter_by_player, $transaction_type, $submit, $previous_page, $max_report) );
	}
}