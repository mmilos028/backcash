...
class ListPlayersForm extends Zend_Form {
	public function __construct($options = null){
        ...
        $filterbystatus->setAttribs(
            array(
                'tabindex'=>$i,
                'class'=>'form-control margin-1 pull-left'
            )
        );
        $i++;
		...
		$this->setDecorators(array(array('ViewScript', array('viewScript'=>'viewScripts/players/ListPlayersViewScript.phtml'))));
