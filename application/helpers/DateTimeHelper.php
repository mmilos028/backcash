...
class DateTimeHelper{
	...
	*/
    ...
    //returns date format in format 21-Oct-2013 for date from yesterday (one day before current day)
	public static function getDateFormat10($nDaysInPast){
		$dateValueTime = time();
		$pastTime = $dateValueTime - $nDaysInPast * 86400;
		return date('d-M-Y', $pastTime);
	}

    //returns date format example: 28-Nov-2014 from current time
	public static function getDateFormat11(){
